  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && (
          <span className="absolute bottom-0 left-0 w-full h-[1px] bg-[#C8A15A]"></span>
        )}
      </button>
      ...
      >
        <div className="container-luxe mx-auto flex gap-[120px] p-12">
          ...
          <div className="flex-1">
            <h3 className="text-[#C8A15A] text-xs uppercase tracking-[0.25em] mb-6">
              By Stone
            </h3>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <Link
                  key={item.label}
                  to={item.to}
                  className="group text-ivory text-sm transition-all duration-180 hover:text-[#C8A15A] py-1 block overflow-hidden"
                >
                  <span className="inline-block transition-transform duration-180 group-hover:translate-x-1.5">
                    {item.label}
                  </span>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-3">
              <Link
                to="/collections"
                className="group text-ivory text-sm transition-all duration-180 hover:text-[#C8A15A] py-1 block"
              >
                Best Sellers
              </Link>
              <Link
              ...
              <div className="mt-8 bg-[#3d2117]/50 rounded-lg p-6 border border-[#C8A15A]/20 shadow-inner">
                <p className="text-ivory text-xs leading-relaxed mb-4">
                  Every bracelet is handcrafted using natural stones chosen for
                  intention, balance and timeless design.
                </p>
                <Link
                  to="/collections"
                  className="text-[#C8A15A] text-xs uppercase tracking-widest hover:underline"
                >
                  Explore Collections →
                </Link>
              </div>
        ...
        <div className="absolute bottom-0 left-0 w-full border-t border-[#C8A15A]/20 p-6 flex justify-between items-center text-ivory text-xs">
          ...
          <Link to="/collections" className="hover:text-[#C8A15A]">
