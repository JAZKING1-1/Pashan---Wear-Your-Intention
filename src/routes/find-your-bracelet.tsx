    ...
    <SiteLayout>
      <main className="flex flex-col min-h-screen">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center p-8 bg-[#F5F2EF] text-[#2E1A14] overflow-hidden">
          ...
          <h1 className="font-serif text-6xl md:text-8xl mb-6 text-center z-10 relative fade-in-up">
            Find Your Stone
          </h1>
          <p className="font-sans text-xl text-center max-w-2xl text-[#2E1A14]/70 z-10 relative fade-in-up delay-200">
            Seven natural stones. Seven different energies. Choose the one that
            aligns with your present intention.
          </p>
          <div className="absolute bottom-10 animate-bounce text-[#2E1A14]/50 z-10">
            Scroll to explore
          </div>
        </section>
        ...
        <section className="py-12 bg-[#2E1A14] text-[#F5F2EF] text-center">
          <p className="font-serif text-2xl italic">
            "The intention you set is the first step of the journey."
          </p>
        </section>
        ...
        <section className="py-20 bg-[#2E1A14] text-[#F5F2EF] px-8">
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="font-sans text-lg mb-6 leading-relaxed text-[#F5F2EF]/80">
                {active.story}
              </p>
              <p className="font-sans italic text-[#B87333]">
                "Natural stones do not change your life. They quietly remind you
